        ...
        plans: [
          {
            name: "Galaxy Promise",
            slug: "galaxy-promise",
            description: "Comprehensive family health plan covering up to six members with the signature 'Premium Promise' to lock in your initial premium rate.",
            whyChoose: "Galaxy Promise is our top recommendation for families. Its signature 'Premium Promise' feature guarantees that your premium will not increase next year just because you made a claim — a rare and valuable commitment in the health insurance industry. With Sum Insured options up to ₹1 Crore and the ability to cover up to 6 family members under a single floater policy, Galaxy Promise offers outstanding protection at an excellent value. The unlimited restoration of the Sum Insured means your coverage is replenished — even in the same year — so multiple hospitalisations within a family do not leave you uncovered.",
            features: [
              "Up to ₹1 Crore Sum Insured",
              "Family Floater Option (up to 6 members)",
          ...
          },
          {
            name: "Galaxy Marvel",
            slug: "galaxy-marvel",
            description: "High-value individual and family plan focusing on rapid coverage for modern treatments and very high Sum Insured.",
            whyChoose: "Galaxy Marvel is designed for those who want the very best — high Sum Insured (up to ₹2 Crore), coverage for modern treatments like robotic surgeries and stem cell therapy, and pre-existing disease coverage that kicks in from just the 31st day for select conditions. The enhanced Multiplier Cumulative Bonus rewards healthy policyholders generously, boosting your Sum Insured significantly over the years without additional premium. Marvel is the plan of choice for executives and professionals who travel frequently, prefer premium hospitals, and want a health plan that matches their lifestyle.",
            features: [
    ...
    providers: [
      {
        ...
        description: "Comprehensive motor insurance solutions for two-wheelers, private cars, and commercial vehicles — partnering with leading general insurers for fast claims and wide garage networks.",
        whyChoose: "BrightLife Insurance partners with multiple leading general insurance companies to bring you the best-priced, most comprehensive motor insurance for every type of vehicle. We compare policies, explain the fine print, and ensure you are never underinsured. Our claims support service means you have a knowledgeable advisor by your side during the stressful process of filing a motor claim — from FIR assistance to garage coordination and settlement follow-up. With a network covering thousands of cashless garages across India, you can get your vehicle repaired quickly and without out-of-pocket expenses.",
        plans: [
          {
